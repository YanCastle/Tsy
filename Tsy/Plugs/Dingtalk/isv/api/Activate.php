...
class Activate
{
    ...
    public static function autoActivateSuite($tmpAuthCode)
    {
        ...
        L("[Activate] activeSuite: " . json_encode($res));
        self::check($res);
    }
